...
(function (global, factory) {
    ...
    function coverRadius(radius, percent) {
        var square = radius * radius * 2; // 导航内容的高低
    ...
    function Calculation(config) {
        ...
        var c = this.config = config,
            ...
            spaceNumber = c.totalAngle === 360 ? itemsNum : itemsNum - 5; // 5 子导航的长度

        this.radius = config.diameter / 2; // 2子导航的方向
